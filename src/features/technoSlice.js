...
const initialState = [
  ...
  },
  {
    ...
    img: maiTai,
    description:
      "Метод приготовления: шейк (В шейкере взбить все ингридиенты, процедить через стрейнер  в бокал, наполненный на 3 четверти кусковым льдом, досыпать фрапе) Бокал: тумблер. Украшение: долька ананаса(10гр), веточка мяты",
    ingredients: [
