...
import bumble from "../assets/img/bumble.png";
...
import mintMar from "../assets/img/mintMar.png";
import greenMix from "../assets/img/greenMix.png";
import kremSoda from "../assets/img/kremSoda.png";
import dushes from "../assets/img/dushes.png";
import latteBergamot from "../assets/img/latte-bergamot.png";
import kedroviyLatte from "../assets/img/kedroviyLatte.png";
import lichy from "../assets/img/lichy.png";
...
const initialState = [
  ...
  },
  {
    ...
    img: matchaCapuch,
    description:
      "взбиваем венчиком в 30мл воды 2г матчи. взбиваем молоко. температура 60 ℃. Сверху готовой матчи вливаем взбитое молоко. Посуда: чашка под американо",
    ingredients: [
      "30мл вода",
      "2г матчи",
      "200 мл молоко",
  ...
  },
  {
    ...
    ingredients: ["120 мл вода", "10г кофе", "1шт печенье", "выход: 120мл"],
  },
  {
    id: 7,
    name: "Макиато",
  ...
  },
  {
    ...
    img: kurkuma,
    description:
      "Поместить все ингредиенты в питчер, взбить как на капучино. Посуда: бокал Айриш",
    ingredients: [
      "2г куркума-порошок",
  ...
  },
  {
    ...
    img: aranchata,
    description:
      "Метод приготовления: билд . Бокал: гибралтар. Украшение: слайс апельсина, слайс лимона. Аранчата п/ф: подготовить сироп фруктозы(1л), апельсины(1кг) и лимоны(1кг). Снять цедру с апельсинов и лимонов (без белой часть корки!), смешать с сиропом, подогреть на плите, немного, не доводя до кипения, дать настояться сутки, добавить апельсиновый и лимонный соки, процедить. ",
    ingredients: [
      "50мл аранчата п/ф",
      "200 мл газировка",
      "выход: 270мл + лед",
  ...
  },
  {
    ...
    img: bumble,
    description:
      "Охладить бокал, заполнить льдом, добавть сок, cироп, долить эспрессо слоями. Посуда: тумблер",
    ingredients: [
      "1шт эспрессо",
  ...
  },
  {
    ...
    img: milkShoc,
    description:
      "все ингредиенты взбиваем в блендере. Посуда: хайбол. Сверху посыпать какао",
    ingredients: [
      "140 г мороженое",
      "100 мл молоко",
      "50мл сливки",
  ...
  },
  {
    ...
    category: "Безалкогольные",
    img: milkVanil_banan,
    description: "все ингредиенты взбиваем в блендере. Посуда: хайбол",
    ingredients: [
      "140 г мороженое",
      "100 мл молоко",
      "50мл сливки",
  ...
  },
  {
    ...
    img: glint,
    description:
      "Слайс яблока и апельсина порезать на 4 части. помещаем все ингредиенты в питчер, подогреваем паровиком не доводя до кипения,  и переливаем в бокал. Посуда: Айриш",
    ingredients: [
      "130мл красное вино",
  ...
  },
  {
    ...
    img: mojito,
    description:
      "Метод приготовления: Свизл (Все ингредиенты налить в тумблер, насыпать лед фрапе, Добавить листья мяты  и равномерно распределить  их ложкой в бокале, досыпать фрапе.) Бокал: Тумблер Украшение: долька лайма, веточка мяты",
    ingredients: [
      "120мл газировка",
      "15г Мята",
      "30мл Сок лайма",
  ...
  },
  {
    ...
    img: maiTai,
    description:
      "Метод приготовления: шейк (В шейкере взбить все ингредиенты, процедить через стрейнер  в бокал, наполненный на 3 четверти кусковым льдом, досыпать фрапе) Бокал: тумблер. Украшение: долька ананаса(10гр), веточка мяты",
    ingredients: [
      "40мл Ананасовый фреш",
...

  {
    ...
    img: margo,
    description:
      "Метод приготовления: шейк, дабл стрейн (В шейкере взбить все ингредиенты процедить через стрейнер и сито в охлажденный бокал). Бокал: коктейльная рюмка. Украшение: Цедра лайма (снимается цедра с лайма, обрезается резаком в виде треугольника, скручивается, кладется сверху )",
    ingredients: [
      "60мл Текила хаус",
      "10мл Сироп агавы",
      "30мл Сок лайма",
  ...
  },
  {
    ...
    img: aperol,
    description:
      "Метод приготовления: билд. Положить слайс апельсина и наполнить бокал на 2/3 льдом, добавить все ингредиенты ",
    ingredients: [
      "120мл Просеко",
      "50мл Апероль",
      "30мл газировка",
  ...
  },
  {
    ...
    description:
      "Метод приготовления: билд. Положить слайс апельсина и наполнить бокал на 2/3 льдом, добавить все ингредиенты ",
    ingredients: ["75мл Тоник", "75мл Мартини Фиеро"],
  },
  {
    id: 29,
    name: "Олдфешен",
  ...
  },
  {
    id: 31,
    name: "Дюшес",
    category: "Сезонные Лимонады",
    img: dushes,
    description:
      "Фреш из груши ( из сорта дюшес), сок лайма, мёд и банановый сироп влить в шейкер, добавить пять кубиков льда, взболтать,  перелить в бокал, заполненный фраппе. Посуда: тумблер.",
    ingredients: [
      "150мл грушевый сок",
      "15мл мед",
      "15мл банановый сироп",
      "30мл сок лайма",
      "выход: 220мл + лед",
    ],
    extName: "Дюшес 1 литр",
    extIngredients: [
      "550мл грушевый сок",
      "45мл мед",
      "45мл банановый сироп",
      "90мл сок лайма",
      "15 куб лед",
      "Посуда: графин",
    ],
  },
  {
    ...
    img: mintMar,
    description:
      "Все ингредиенты взбить в блендере с 6-ю кубиками льда, перелить в бокал.  Украсить веточкой мяты. Посуда: тумблер.",
    ingredients: [
      "80г Пюре маракуйа",
      "150мл Сок апельсиновый",
      "4г Корень имбиря очищенный",
      "5г Мята ",
      "30мл Сироп сахарный ",
      "выход: 400мл",
    ],
    extName: "Мята – маракуйа 1 литр.",
    extIngredients: [
      "240г Пюре маракуйа",
      "350мл Сок апельсиновый",
      "12г Корень имбиря очищенный",
      "15г Мята ",
      "90мл Сироп сахарный ",
      "15 куб лед",
      "Посуда: графин",
  ...
  },
  {
    ...
    category: "Сезонные Лимонады",
    img: greenMix,
    description: "Бленд 4 куб льда. Посуда: тумблер.",
    ingredients: [
      "150мл грушевый сок",
      "60г Банан",
      "60г Шпинат ",
      "20мл сок лимона",
      "30г миндаль",
      "20мл Сироп топинамбура",
      "выход: 400мл",
    ],
    extName: "Зеленый микс - 1 литр",
    extIngredients: [
      "450мл грушевый сок",
      "180г Банан",
      "180г Шпинат ",
  ...
  },
  {
    ...
    img: kremSoda,
    description:
      "Взбить ингредиенты и 50 мл газировки в блендере до растворения аквафабы. Перелить в бокал с кусковым льдом. Долить газировку. Посуда: тумблер.",
    ingredients: [
      "30мл Сироп ваниль",
      "10мл Сироп карамель",
      "30мл Сок лайма",
  ...
  },
  {
    id: 400,
    name: "Личи-кумкват",
    category: "Сезонные Согревающие",
    img: lichy,
    description:
      "Метод приготовления: кумкват порезать на половинки, помять в чайнике, клубнику порезать на половинки и добавить в чайник вместе с остальными ингредиентами, подогреть паровиком",
    ingredients: [
      "Имбирь 30г ",
      "Клубника замороженная 60г",
      "Кумкват 30г",
      "Сироп из личи 30мл",
      "Мед 20мл",
      "Выход 500 мл",
  ...
  },
  {
    ...
    img: latteBergamot,
    description:
      "Заварить чай в 50 мл., процедить, растворить сахар, взбить молоко, влить получившийся сироп из чая, посыпать сверху на пену черную смородину. Желательно сделать заготовку из чая и сахара - сварить сироп. Бокал Айриш",
    ingredients: [
      "Чай Эрл Грей 2г ",
      "Кокосовое молоко 150 мл",
      "Ванильный сахар 7 г",
      "Черная смородина сублимированная 0.3г",
      "Выход 220 мл",
    ],
  },
  {
    id: 403,
    name: "Кедрово-Лимонный латте",
    category: "Сезонные Согревающие",
    img: kedroviyLatte,
    description:
      "Взбить молоко с сиропом, добавить эспрессо , положить шишку на пену, посыпать лимоном",
    ingredients: [
      "Кедровое молоко 150мл",
      "Эспрессо 1шт",
      "Лимон сублимированный 0.3г",
      "Кленовый сироп 5мл",
      "Кедровая шишка на украшение. Положить на пену ",
      "Выход 220 мл",
    ],
  },
  {
    ...
    category: "Сезонные Согревающие",
    img: colors,
    description: "Положить готовую чайную смесь в чайник. залить кипятком ",
    ingredients: ["чай 'Краски Крыма' 10г", "Выход 500 мл"],
  },
  {
    id: 401,
    name: "Шиповник-апельсин",
    category: "Сезонные Согревающие",
    img: "",
    description:
      "Шиповник помять в чайнике с небольшим количеством кипятка, слайс апельсина порезать на сегменты, добавить в чайник с остальными ингредиентами, подогреть паровиком до кипения. Чай заваривается 4-6 минут.",
    ingredients: [
      "Шиповник сушеный 50г",
      "Апельсин 50г",
      "Сахарный сироп 50мл",
      "Бадьян 1зв(2.5г)",
      "Корица 1 дэш(0.2г)",
